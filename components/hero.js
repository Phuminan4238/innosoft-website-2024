...
import heroImg from "../public/img/innosoft-hero.png";
          ...
          <div className="max-w-2xl mb-8">
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row pb-6">
              <a
                ...
                target="_blank"
                rel="noopener"
                className="flex items-center px-8 py-1 text-lg font-medium text-blue-500 border border-blue-500 rounded-3xl"
              >
                <span className="mr-6">
                  <Image
                    src="/img/crown-logo2.png"
                    alt="Crown"
                    width="24"
                    height="24"
                    className="w-6 h-6"
            ...
            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              {selectedLanguage === "en" ? "LET’s BUILD" : "LET’s BUILD"}
            </h1>

            <h1 className="text-4xl font-bold leading-snug tracking-tight text-gray-800 lg:text-4xl lg:leading-tight xl:text-6xl xl:leading-tight dark:text-white">
              THE NEXT <span className="font-light">BIG THING</span>
            </h1>

            <p
              className="font-thai py-5 text-xl font-medium leading-normal  text-gray-700 lg:text-xl xl:text-xl dark:text-gray-300"
              // style={{ maxWidth: "580px" }}
            >
              {selectedLanguage === "en"
                ? "ยินดีต้อนรับ สู่ หน่วยงานนวัตกรรมซอฟท์แวร์ และ "
                : "ยินดีต้อนรับ สู่ หน่วยงานนวัตกรรมซอฟท์แวร์ และ "}
              <br></br>
              {selectedLanguage === "en"
                ? "      ระบบการประมวลผลประสิทธิภาพสูง พวกเราทำงานด้วยความมุ่งมั่น"
                : "      ระบบการประมวลผลประสิทธิภาพสูง พวกเราทำงานด้วยความมุ่งมั่น"}
              <br></br>
              {selectedLanguage === "en"
                ? "ที่จะค้นหาความเป็นไปได้ใหม่ๆ ในการแก้ไขปัญหาของผู้คน "
                : "ที่จะค้นหาความเป็นไปได้ใหม่ๆ ในการแก้ไขปัญหาของผู้คน "}
            </p>
            <p className="font-thai pb-6 leading-normal text-gray-400 lg:text-xl xl:text-xl dark:text-gray-300">
              ประสบการณ์ในการออกแบบและพัฒนาระบบ ตลอด 14ปี ที่ผ่านมา
              <br></br> ในปีนี้ เรากำลังจะก้าวเข้าสู่บทบาทใหม่ และ
              เว็บไซต์ใหม่...
            </p>

            <div className="font-thai flex flex-col items-start space-y-3 pt-4 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="https://web3templates.com/templates/nextly-landing-page-template-for-startups"
                target="_blank"
                rel="noopener"
                className="px-5 py-2 text-lg font-semibold text-orange-600 border border-orange-600 rounded-3xl "
              >
                เว็บไซต์ใหม่กำลังมา โปรดติดตาม . . .
              </a>
